const details = [
	"Custom texture systems",
	"Decorative overlay applications",
	"Vertical feature wall finishes",
	"Stamped and carved patterns",
	"Color staining & metallic effects",
	"Protective topcoat sealing",
];
