export default function BlogHeroSection() {
	return (
		<section className="relative overflow-hidden border-b border-[#ffffff1a] bg-linear-to-b from-[#1a1d23] via-[#12151a] to-[#0D0F12] py-14 md:py-20">
			...
			<div className="container relative z-10 mx-auto px-4 md:px-8">
				<div className="mx-auto flex max-w-4xl flex-col items-center justify-center space-y-3 text-center md:space-y-4">
					<p className="font-sans text-xs uppercase tracking-[0.35em] text-white/70 md:text-sm">
						TopCoat Journal
					</p>
