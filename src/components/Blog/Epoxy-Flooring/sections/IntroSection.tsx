	...
	return (
		<div className="w-full pt-8">
			...
			<p className="mt-5 max-w-4xl font-sans text-base leading-relaxed text-secondary-foreground/70 md:text-lg">
				...
				an industrial facility, <Link href="/services/epoxy-flooring-wayne-new-jersey" className="text-primary">epoxy flooring</Link> delivers performance, aesthetics, and
