...
export default function SystemsSection() {
  return (
    <section className="border-b border-charcoal-lighter py-16">
      ...
      <p className="mt-4 font-sans text-base leading-relaxed text-secondary-foreground/70"><strong>Quick Answer:</strong> There are three main types of <Link href="/" className="text-primary">
          terrazzo flooring
