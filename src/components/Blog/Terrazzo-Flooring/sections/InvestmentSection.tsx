...
export default function InvestmentSection() {
  return (
    <section className="border-b border-charcoal-lighter py-16">
      ...
      <p className="mb-4 font-sans text-base leading-relaxed text-secondary-foreground/70"><strong>Quick Answer:</strong> Terrazzo flooring
        typically costs $20 to $70 per square foot in North Jersey, depending on materials and design complexity.</p>
