...
const benefits = [
	"Residential & Commercial Terrazzo for high-traffic lobbies, kitchens, and retail hubs",
	"Terrazzo Polishing Services using diamond-grinding technology to restore original luster",
	"Sustainable durability with a weather-resistant and industrial-grade finish",
	"Custom color and aggregate combinations for tailored design flexibility",
	"Exceptional long-term durability with minimal maintenance",
		...
		<section className="bg-[#14161A] py-20 overflow-hidden" ref={ref}>
			<div className="container mx-auto px-4">
					...
					<div className={`transition-all duration-700 ${isVisible ? "translate-x-0 opacity-100" : "-translate-x-10 opacity-0"}`}>
						...
						<h3 className="mb-4 inline bg-red-400 px-2 font-serif text-xl font-semibold text-white">Professional Terrazzo Floor Installation & Restoration in Wayne, NJ</h3>
						<p className="mb-8 font-sans leading-relaxed text-white/70">
